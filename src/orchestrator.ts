...
import { Agent, AgentDescription, AgentResponse } from "./agents/agent";
...
export interface RequestMetadata {
  ...
  // Child agents used for the agent
  agentChilds?: Record<string, AgentDescription>;
...
export class MultiAgentOrchestrator {
  ...
  getAllAgents(): { [key: string]: AgentDescription } {
  ...
  private createMetadata(
    ...
    return {
      ...
      agentModel: intentClassifierResult.selectedAgent.getModel(),
      agentChilds: intentClassifierResult.selectedAgent.getChilds()    
    };
  }
