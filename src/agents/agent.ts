...
export interface AgentDescription {
  ...
  childs: { [key: string]: AgentDescription };
}
...
export abstract class Agent {
  public static readonly MODEL_NOT_AVAILABLE = "Model not available";
  ...
  /**
   * Abstract method to get the model used in the agent.
   * This method must be implemented by all concrete agent classes.
   *
   * @returns The model used in the agent.
   */
  abstract getModel(): string;

  /**
   * Abstract method to get the child agents used in the agent.
   * This method must be implemented by all concrete agent classes.
   *
   * @returns The agents used in the agent.
   */
  abstract getChilds(): { [key: string]: AgentDescription };
}
